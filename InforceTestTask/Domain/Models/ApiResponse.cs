...
namespace InforceTestTask.Domain.Models;
    ...
    T data = default)
{
    ...
    public static ApiResponse<T> NotFound(string description = "Entity was not found") 
        => new(HttpStatusCode.NotFound, description);
...
public class ApiResponse
{
    ...
    public static ApiResponse Forbidden(string error = "You have no permission to perform this action")
